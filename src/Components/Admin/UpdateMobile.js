    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-6">
          ...
          {data.ipxRating && (
            <div className="boxLayout d-flex-justify-align">abc8</div>
          )}
          {data.displayType === null && (
            <div className="boxLayout d-flex-justify-align">abc9</div>
          )}
          {data.displayHz === -1 && (
            <div className="boxLayout d-flex-justify-align">abc10</div>
          )}
          {data.displayResolutionHeight === -1 && (
            <div className="boxLayout d-flex-justify-align">abc11</div>
          )}
          {data.displayResolutionWidth === -1 && (
            <div className="boxLayout d-flex-justify-align">abc12</div>
          )}
          {data.os === null && (
            <div className="boxLayout d-flex-justify-align">abc13</div>
          )}
          {data.cpuNoOfCores === -1 && (
